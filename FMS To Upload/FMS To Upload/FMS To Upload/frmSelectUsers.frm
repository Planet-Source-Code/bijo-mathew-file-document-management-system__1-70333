...
Begin VB.Form frmSelectUsers 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdSave 
         ...
         Height          =   375
         Left            =   1800
         MouseIcon       =   "frmSelectUsers.frx":0442
      ...
      Begin VB.CommandButton cmdRemoveUser 
         ...
         Height          =   375
         Left            =   2760
         MouseIcon       =   "frmSelectUsers.frx":074C
         MousePointer    =   99  'Custom
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   6960
      ...
      Begin VB.CommandButton cmdExit 
         ...
         Height          =   375
         Left            =   3720
         MouseIcon       =   "frmSelectUsers.frx":0A56
         MousePointer    =   99  'Custom
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   7560
      ...
      Begin VB.CommandButton cmdAddUser 
         ...
         Height          =   375
         Left            =   2880
         MouseIcon       =   "frmSelectUsers.frx":0D60
         MousePointer    =   99  'Custom
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   4080
...
ElseIf Len(MSFUsers.Text) > 0 Then
    frmUserRights.Show , Me
    Me.Enabled = False
    frmUserRights.Frame1.Caption = "Rights for: " & MSFUsers.Text
...
Call cloneFlexi(MSFActiveUsers, frmFileProperties.MSFActiveUsers)
Unload Me
End Sub
...
Call cloneFlexi(frmFileProperties.MSFActiveUsers, MSFActiveUsers)
End Sub

Private Sub Form_Unload(Cancel As Integer)
frmFileProperties.Enabled = True
frmFileProperties.SetFocus
End Sub
